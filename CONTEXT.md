...
a Workspace. The domain vocabulary below is written under the working name **Crucible**, which Secant replaced; read Crucible as Secant. See
[ADR 0028](./docs/adr/0028-adopt-secant-as-the-product-package-and-command-name.md).
