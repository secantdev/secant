...
| npm package         | `secant`           | Unpublished on npm; `@secantdev/secant` is the fallback if the bare name cannot be claimed under authentication.                                                                                                                                                                                                                                                                                                                     |
...
2. An authenticated `npm publish --dry-run` for `secant`. The npm user and organization pages returned access errors during research, so the npm
   scope is unverified. The organization and repository rename that this gate also named was completed on 2026-09-07 (amended 2026-09-07).
